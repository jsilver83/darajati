    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boundary_range_upper', models.DecimalField(blank=True, decimal_places=2, help_text='When the type is subjective and it is not free, give a positive range', max_digits=5, null=True, verbose_name='Boundary Range Upper')),
                ('boundary_range_lower', models.DecimalField(blank=True, decimal_places=2, help_text='When the type is subjective and it is not free, give a negative range', max_digits=5, null=True, verbose_name='Boundary Range Lower')),
                ...
                ('student_total_grading', models.BooleanField(default=False, help_text='If this is checked, It will be calculated in the total mark', verbose_name='Calculate In Student Grading?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='enrollment.UserProfile')),
            ],
        ),
