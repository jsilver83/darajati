    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('late_deduction', models.DecimalField(decimal_places=2, max_digits=4, null=True, verbose_name='late deduction')),
                ('absence_deduction', models.DecimalField(decimal_places=2, max_digits=4, null=True, verbose_name='absence deduction')),
