# Generated by Django 2.0.1 on 2018-12-19 08:22
...
class Migration(migrations.Migration):
    dependencies = [
        ('attendance', '0005_attendance_boundary_function'),
    ]

    operations = [
        migrations.RunSQL(
            """
            CREATE OR REPLACE FUNCTION enrollment_attendance_deduction(enrollment_id integer)
                  RETURNS DECIMAL AS
                $BODY$
