...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attendance_entry_window', models.IntegerField(default=7, null=True, verbose_name='attendance window')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('letter_grade', models.CharField(default='UD', max_length=10, null=True, verbose_name='letter grade')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade_fragment_deadline', models.DateTimeField(null=True, verbose_name='Grade Break Down Deadline Date')),
                ('code', models.CharField(max_length=20, null=True)),
                ('description', models.CharField(max_length=255, null=True)),
            ],
        ),
