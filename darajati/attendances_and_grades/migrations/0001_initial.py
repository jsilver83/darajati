...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='student',
            name='user_profile',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='student', to='attendances_and_grades.UserProfile'),
        ),
        migrations.AddField(
            model_name='section',
            name='semester',
        ...
        migrations.AddField(
            ...
            name='user_profile',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='instructor', to='attendances_and_grades.UserProfile'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='attendance',
            name='enrolment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendances', to='attendances_and_grades.Enrollment'),
        ),
    ]
